...
func GetBlockWeight(blk *vdsutil.Block) int64 {
...
func GetTransactionWeight(tx *vdsutil.Tx) int64 {
	msgTx := tx.MsgTx()
...
func GetSigOpCost(tx *vdsutil.Tx, isCoinBaseTx bool, utxoView *UtxoViewpoint, bip16, segWit bool) (int, error) {
