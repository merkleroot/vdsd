...
// is the zeroHash.
func BuildMerkleTreeStore(transactions []*vdsutil.Tx, witness bool) []*chainhash.Hash {
...
func ExtractWitnessCommitment(tx *vdsutil.Tx) ([]byte, bool) {
...
func ValidateWitnessCommitment(blk *vdsutil.Block) error {
