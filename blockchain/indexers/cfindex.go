...
func storeFilter(dbTx database.Tx, block *vdsutil.Block, f *gcs.Filter,
...
func (idx *CfIndex) ConnectBlock(dbTx database.Tx, block *vdsutil.Block,
...
func (idx *CfIndex) DisconnectBlock(dbTx database.Tx, block *vdsutil.Block,
