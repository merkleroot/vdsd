...
func dbIndexConnectBlock(dbTx database.Tx, indexer Indexer, block *vdsutil.Block,
...
func dbIndexDisconnectBlock(dbTx database.Tx, indexer Indexer, block *vdsutil.Block,
	stxo []blockchain.SpentTxOut) error {
...
//
// This is part of the blockchain.IndexManager interface.
func (m *Manager) ConnectBlock(dbTx database.Tx, block *vdsutil.Block,
...
//
// This is part of the blockchain.IndexManager interface.
func (m *Manager) DisconnectBlock(dbTx database.Tx, block *vdsutil.Block,
	stxo []blockchain.SpentTxOut) error {
