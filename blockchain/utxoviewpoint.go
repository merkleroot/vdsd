...
func (view *UtxoViewpoint) AddTxOut(tx *vdsutil.Tx, txOutIdx uint32, blockHeight int32) {
...
func (view *UtxoViewpoint) AddTxOuts(tx *vdsutil.Tx, blockHeight int32) {
...
func (view *UtxoViewpoint) connectTransaction(tx *vdsutil.Tx, blockHeight int32, stxos *[]SpentTxOut) error {
...
func (view *UtxoViewpoint) connectTransactions(block *vdsutil.Block, stxos *[]SpentTxOut) error {
...
func (view *UtxoViewpoint) disconnectTransactions(db database.DB, block *vdsutil.Block, stxos []SpentTxOut) error {
...
// not modified.
func (view *UtxoViewpoint) fetchInputUtxos(db database.DB, block *vdsutil.Block) error {
...
func (b *BlockChain) FetchUtxoView(tx *vdsutil.Tx) (*UtxoViewpoint, error) {
