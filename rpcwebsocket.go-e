...
// processing.
func (m *wsNotificationManager) NotifyBlockConnected(block *vdsutil.Block) {
...
func (m *wsNotificationManager) NotifyBlockDisconnected(block *vdsutil.Block) {
...
func (m *wsNotificationManager) NotifyMempoolTx(tx *vdsutil.Tx, isNew bool) {
...
//
// NOTE: This extension was ported from github.com/decred/dcrd
func (f *wsClientFilter) addAddress(a vdsutil.Address) {
	switch a := a.(type) {
...
func (f *wsClientFilter) addAddressStr(s string, params *chaincfg.Params) {
	...
	// script.
	a, err := vdsutil.DecodeAddress(s, params)
	if err != nil {
		return
	}
	f.addAddress(a)
...
//
// NOTE: This extension was ported from github.com/decred/dcrd
func (f *wsClientFilter) existsAddress(a vdsutil.Address) bool {
	switch a := a.(type) {
	case *vdsutil.AddressPubKeyHash:
...
//
// NOTE: This extension was ported from github.com/decred/dcrd
func (f *wsClientFilter) removeAddress(a vdsutil.Address) {
	switch a := a.(type) {
	case *vdsutil.AddressPubKeyHash:
...
// Notification types
type notificationBlockConnected vdsutil.Block
type notificationBlockDisconnected vdsutil.Block
...
func (m *wsNotificationManager) subscribedClients(tx *vdsutil.Tx,
...
// reorganize).
func (*wsNotificationManager) notifyBlockDisconnected(clients map[chan struct{}]*wsClient, block *vdsutil.Block) {
...
func (m *wsNotificationManager) notifyForNewTx(clients map[chan struct{}]*wsClient, tx *vdsutil.Tx) {
	...
	ntfn := btcjson.NewTxAcceptedNtfn(txHashStr, vdsutil.Amount(amount).ToBTC())
	marshalledJSON, err := btcjson.MarshalCmd(nil, ntfn)
	if err != nil {
...
func (m *wsNotificationManager) addSpentRequests(opMap map[wire.OutPoint]map[chan struct{}]*wsClient,
	...
	spends := make(map[chainhash.Hash]*vdsutil.Tx)
	for _, op := range ops {
...
func blockDetails(block *vdsutil.Block, txIndex int) *btcjson.BlockDetails {
	if block == nil {
		return nil
	}
...
func newRedeemingTxNotification(txHex string, index int, block *vdsutil.Block) ([]byte, error) {
...
// notifications.
func (m *wsNotificationManager) notifyRelevantTxAccepted(tx *vdsutil.Tx,
...
func checkAddressValidity(addrs []string, params *chaincfg.Params) error {
	for _, addr := range addrs {
		_, err := vdsutil.DecodeAddress(addr, params)
		if err != nil {
...
func rescanBlock(wsc *wsClient, lookups *rescanKeys, blk *vdsutil.Block) {
...
//
// NOTE: This extension is ported from github.com/decred/dcrd
func rescanBlockFilter(filter *wsClientFilter, block *vdsutil.Block, params *chaincfg.Params) []string {
...
func descendantBlock(prevHash *chainhash.Hash, curBlock *vdsutil.Block) error {
...
func handleRescan(wsc *wsClient, icmd interface{}) (interface{}, error) {
	...
	for _, addrStr := range cmd.Addresses {
		addr, err := vdsutil.DecodeAddress(addrStr, params)
		if err != nil {
			jsonErr := btcjson.RPCError{
				Code: btcjson.ErrRPCInvalidAddressOrKey,
...
fetchRange:
	...
	// Notify websocket client of the finished rescan.  Due to how vdsd
