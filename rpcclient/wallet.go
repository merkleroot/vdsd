...
func (c *Client) ListUnspentMinMaxAddressesAsync(minConf, maxConf int, addrs []vdsutil.Address) FutureListUnspentResult {
...
func (c *Client) ListUnspentMinMaxAddresses(minConf, maxConf int, addrs []vdsutil.Address) ([]btcjson.ListUnspentResult, error) {
...
func (c *Client) SetTxFeeAsync(fee vdsutil.Amount) FutureSetTxFeeResult {
...
func (c *Client) SetTxFee(fee vdsutil.Amount) error {
...
func (c *Client) SendToAddressCommentAsync(address vdsutil.Address,
	amount vdsutil.Amount, comment,
...
// NOTE: This function requires to the wallet to be unlocked.  See the
// WalletPassphrase function for more details.
func (c *Client) SendFromComment(fromAccount string, toAddress vdsutil.Address,
	amount vdsutil.Amount, minConfirms int,
...
func (r FutureAddMultisigAddressResult) Receive() (vdsutil.Address, error) {
	res, err := receiveFuture(r)
	if err != nil {
		return nil, err
	}
	...
	return vdsutil.DecodeAddress(addr, &chaincfg.MainNetParams)
}
...
func (c *Client) AddMultisigAddressAsync(requiredSigs int, addresses []vdsutil.Address, account string) FutureAddMultisigAddressResult {
...
func (c *Client) CreateMultisigAsync(requiredSigs int, addresses []vdsutil.Address) FutureCreateMultisigResult {
	addrs := make([]string, 0, len(addresses))
	for _, addr := range addresses {
		addrs = append(addrs, addr.String())
	}
...
// multisignature address and script needed to redeem it.
func (c *Client) CreateMultisig(requiredSigs int, addresses []vdsutil.Address) (*btcjson.CreateMultiSigResult, error) {
...
// address.
func (r FutureGetNewAddressResult) Receive() (vdsutil.Address, error) {
	res, err := receiveFuture(r)
	if err != nil {
		return nil, err
	}
...
func (c *Client) GetNewAddress(account string) (vdsutil.Address, error) {
...
func (r FutureGetRawChangeAddressResult) Receive() (vdsutil.Address, error) {
	res, err := receiveFuture(r)
	if err != nil {
		return nil, err
	}
...
func (c *Client) GetRawChangeAddress(account string) (vdsutil.Address, error) {
...
// address.
func (r FutureAddWitnessAddressResult) Receive() (vdsutil.Address, error) {
	res, err := receiveFuture(r)
	if err != nil {
		return nil, err
	}
...
func (c *Client) AddWitnessAddress(address string) (vdsutil.Address, error) {
...
func (r FutureGetAccountAddressResult) Receive() (vdsutil.Address, error) {
	res, err := receiveFuture(r)
	if err != nil {
		return nil, err
	}
...
func (c *Client) GetAccountAddress(account string) (vdsutil.Address, error) {
...
func (c *Client) GetAccountAsync(address vdsutil.Address) FutureGetAccountResult {
	addr := address.EncodeAddress()
...
func (c *Client) GetAccount(address vdsutil.Address) (string, error) {
...
func (c *Client) SetAccountAsync(address vdsutil.Address, account string) FutureSetAccountResult {
	addr := address.EncodeAddress()
...
func (c *Client) SetAccount(address vdsutil.Address, account string) error {
...
func (r FutureGetAddressesByAccountResult) Receive() ([]vdsutil.Address, error) {
	res, err := receiveFuture(r)
	if err != nil {
		return nil, err
	}
	...
	addrs := make([]vdsutil.Address, 0, len(addrStrings))
	for _, addrStr := range addrStrings {
		addr, err := vdsutil.DecodeAddress(addrStr,
...
// passed account.
func (c *Client) GetAddressesByAccount(account string) ([]vdsutil.Address, error) {
...
func (c *Client) MoveAsync(fromAccount, toAccount string, amount vdsutil.Amount) FutureMoveResult {
...
func (c *Client) Move(fromAccount, toAccount string, amount vdsutil.Amount) (bool, error) {
...
func (c *Client) MoveMinConfAsync(fromAccount, toAccount string,
	amount vdsutil.Amount, minConfirms int) FutureMoveResult {
...
func (c *Client) MoveMinConf(fromAccount, toAccount string, amount vdsutil.Amount, minConf int) (bool, error) {
...
func (c *Client) MoveCommentAsync(fromAccount, toAccount string,
	amount vdsutil.Amount, minConfirms int, comment string) FutureMoveResult {
...
func (c *Client) MoveComment(fromAccount, toAccount string, amount vdsutil.Amount,
...
func (c *Client) ValidateAddressAsync(address vdsutil.Address) FutureValidateAddressResult {
	addr := address.EncodeAddress()
...
func (c *Client) ValidateAddress(address vdsutil.Address) (*btcjson.ValidateAddressWalletResult, error) {
...
func (r FutureListAccountsResult) Receive() (map[string]vdsutil.Amount, error) {
	res, err := receiveFuture(r)
	if err != nil {
		return nil, err
	}
	...
	accountsMap := make(map[string]vdsutil.Amount)
	for k, v := range accounts {
		amount, err := vdsutil.NewAmount(v)
		if err != nil {
			return nil, err
		}
...
func (c *Client) ListAccounts() (map[string]vdsutil.Amount, error) {
...
func (c *Client) ListAccountsMinConf(minConfirms int) (map[string]vdsutil.Amount, error) {
...
func (r FutureGetBalanceResult) Receive() (vdsutil.Amount, error) {
	res, err := receiveFuture(r)
	if err != nil {
		return 0, err
	}
	...
	amount, err := vdsutil.NewAmount(balance)
	if err != nil {
		return 0, err
	}
...
// Receive waits for the response promised by the future and returns the
// available balance from the server for the specified account.
func (r FutureGetBalanceParseResult) Receive() (vdsutil.Amount, error) {
	res, err := receiveFuture(r)
	if err != nil {
		return 0, err
	}
...
func (c *Client) GetBalance(account string) (vdsutil.Amount, error) {
...
func (c *Client) GetBalanceMinConf(account string, minConfirms int) (vdsutil.Amount, error) {
...
func (r FutureGetReceivedByAccountResult) Receive() (vdsutil.Amount, error) {
	res, err := receiveFuture(r)
	if err != nil {
		return 0, err
	}
...
// confirmations.
func (c *Client) GetReceivedByAccount(account string) (vdsutil.Amount, error) {
...
func (c *Client) GetReceivedByAccountMinConf(account string, minConfirms int) (vdsutil.Amount, error) {
...
func (r FutureGetUnconfirmedBalanceResult) Receive() (vdsutil.Amount, error) {
	res, err := receiveFuture(r)
	if err != nil {
		return 0, err
	}
...
func (c *Client) GetUnconfirmedBalance(account string) (vdsutil.Amount, error) {
...
func (r FutureGetReceivedByAddressResult) Receive() (vdsutil.Amount, error) {
	res, err := receiveFuture(r)
	if err != nil {
		return 0, err
	}
...
func (c *Client) GetReceivedByAddressAsync(address vdsutil.Address) FutureGetReceivedByAddressResult {
	addr := address.EncodeAddress()
...
func (c *Client) GetReceivedByAddressMinConfAsync(address vdsutil.Address, minConfirms int) FutureGetReceivedByAddressResult {
	addr := address.EncodeAddress()
...
func (c *Client) SignMessageAsync(address vdsutil.Address, message string) FutureSignMessageResult {
	addr := address.EncodeAddress()
...
// NOTE: This function requires to the wallet to be unlocked.  See the
// WalletPassphrase function for more details.
func (c *Client) SignMessage(address vdsutil.Address, message string) (string, error) {
...
func (c *Client) VerifyMessageAsync(address vdsutil.Address, signature, message string) FutureVerifyMessageResult {
	addr := address.EncodeAddress()
...
// NOTE: This function requires to the wallet to be unlocked.  See the
// WalletPassphrase function for more details.
func (c *Client) VerifyMessage(address vdsutil.Address, signature, message string) (bool, error) {
...
// (WIF)
func (r FutureDumpPrivKeyResult) Receive() (*vdsutil.WIF, error) {
	res, err := receiveFuture(r)
	if err != nil {
		return nil, err
	}
	...
	return vdsutil.DecodeWIF(privKeyWIF)
}
...
func (c *Client) DumpPrivKeyAsync(address vdsutil.Address) FutureDumpPrivKeyResult {
	addr := address.EncodeAddress()
...
func (c *Client) ImportPrivKeyAsync(privKeyWIF *vdsutil.WIF) FutureImportPrivKeyResult {
	wif := ""
	if privKeyWIF != nil {
...
// format (WIF).
func (c *Client) ImportPrivKey(privKeyWIF *vdsutil.WIF) error {
...
//
// See ImportPrivKey for the blocking version and more details.
func (c *Client) ImportPrivKeyLabelAsync(privKeyWIF *vdsutil.WIF, label string) FutureImportPrivKeyResult {
	wif := ""
	if privKeyWIF != nil {
		wif = privKeyWIF.String()
	}
...
func (c *Client) ImportPrivKeyLabel(privKeyWIF *vdsutil.WIF, label string) error {
...
//
// See ImportPrivKey for the blocking version and more details.
func (c *Client) ImportPrivKeyRescanAsync(privKeyWIF *vdsutil.WIF, label string, rescan bool) FutureImportPrivKeyResult {
	wif := ""
	if privKeyWIF != nil {
		wif = privKeyWIF.String()
	}
...
func (c *Client) ImportPrivKeyRescan(privKeyWIF *vdsutil.WIF, label string, rescan bool) error {
...
// NOTE: While getinfo is implemented here (in wallet.go), a vdsd chain server
