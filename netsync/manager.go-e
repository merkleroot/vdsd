...
import (
	...
	peerpkg "github.com/merkleroot/vdsd/peer"
...
func (sm *SyncManager) handleBlockchainNotification(notification *blockchain.Notification) {
	...
	case blockchain.NTBlockAccepted:
		...
		block, ok := notification.Data.(*vdsutil.Block)
		if !ok {
...
// processed.
func (sm *SyncManager) QueueTx(tx *vdsutil.Tx, peer *peerpkg.Peer, done chan struct{}) {
...
// processed.
func (sm *SyncManager) QueueBlock(block *vdsutil.Block, peer *peerpkg.Peer, done chan struct{}) {
...
// chain.
func (sm *SyncManager) ProcessBlock(block *vdsutil.Block, flags blockchain.BehaviorFlags) (bool, error) {
