...
func ExamplePayToAddrScript() {
	// Parse the address to send the coins to into a vdsutil.Address
	// which is useful to ensure the accuracy of the address and determine
	// the address type.  It is also required for the upcoming call to
	// PayToAddrScript.
	addressStr := "Leqay1p3dWuprsnwUjM2SBbrH9BiphaDUL"
	address, err := vdsutil.DecodeAddress(addressStr, &chaincfg.MainNetParams)
	if err != nil {
		fmt.Println(err)
		return
	}
...
func ExampleSignTxOutput() {
	...
	pubKeyHash := vdsutil.Hash160(pubKey.SerializeCompressed())
	addr, err := vdsutil.NewAddressPubKeyHash(pubKeyHash,
	...
	lookupKey := func(a vdsutil.Address) (*btcec.PrivateKey, bool, error) {
