...
// a slice of them.
func loadBlocks(t *testing.T, dataFile string, network wire.BitcoinNet) ([]*vdsutil.Block, error) {
	...
	blocks := make([]*vdsutil.Block, 0, 256)
	genesis := vdsutil.NewBlock(chaincfg.MainNetParams.GenesisBlock)
