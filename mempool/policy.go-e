...
const (
	...
	DefaultMinRelayTxFee = vdsutil.Amount(1000)
...
// pool and relayed.
func calcMinRequiredTxRelayFee(serializedSize int64, minRelayTxFee vdsutil.Amount) int64 {
	...
	if minFee < 0 || minFee > vdsutil.MaxSatoshi {
		minFee = vdsutil.MaxSatoshi
	}
...
func checkInputsStandard(tx *vdsutil.Tx, utxoView *blockchain.UtxoViewpoint) error {
...
func isDust(txOut *wire.TxOut, minRelayTxFee vdsutil.Amount) bool {
...
func checkTransactionStandard(tx *vdsutil.Tx, height int32,
	medianTimePast time.Time, minRelayTxFee vdsutil.Amount,
...
func GetTxVirtualSize(tx *vdsutil.Tx) int64 {
	// vSize := (weight(tx) + 3) / 4
