...
var (
	...
	defaultDataDir  = filepath.Join(vdsdHomeDir, "data")
...
type config struct {
	DataDir        string `short:"b" long:"datadir" description:"Location of the vdsd data directory"`
...
// time of writing, vdsd currently places blocks for testnet version 3 in the
